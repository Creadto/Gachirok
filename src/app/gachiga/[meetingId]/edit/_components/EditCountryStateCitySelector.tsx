...
interface EditCountryStateCitySelectorProps {
  originalCountry: string | undefined;
  originalState: string | undefined;
  originalCity: string | undefined;
 ...
 * @author 김영서
 **/
const EditCountryStateCitySelector = ({
  originalCountry,
  originalState,
  originalCity,
  register,
  ...
  registerStateCode,
  registerCityCode,
}: EditCountryStateCitySelectorProps) => {
  ...
  const [selectedCity, setSelectedCity] = useState<string>(originalCity || "");
...
export default EditCountryStateCitySelector;
