...
import { EditEndTimeDropdown } from "./EditEndTimeDropdown";

interface EditEndTimeButtonProps {
...
export const EditEndTimeButton = ({
  meetingData,endHour, endMinute, setEndHour, setEndMinute
}: EditEndTimeButtonProps) => {
