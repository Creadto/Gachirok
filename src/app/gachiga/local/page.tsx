  ...
  return (
    <>
      <div className="ml-10 w-[95%] pr-24">
        <div className="flex flex-row gap-x-[10px] mt-10 text-[22px] items-center">
          <div>
            <GachigaIcon />
          </div>
          <div>
        ...
        <div>
          <p className="font-bold flex-1 pt-5">{meetings.length}개 모임</p>
            ...
            {currentMeetings.map((meeting, index) => (
              ...
              >
                ...
                >
                  ...
                  <div className="p-3 ">
                    <p className="text-sm text-gray-500 pt-1 flex">
                      9/11 16:20
                    </p>
