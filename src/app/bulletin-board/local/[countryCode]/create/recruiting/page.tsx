...
interface AddRecruitingBulletinBoardPageProps {
  params: {
    countryCode: string;
  };
}
 ...
 * @author 김영서
 **/
export default function AddRecruitingBulletinBoardPage({
  params,
}: AddRecruitingBulletinBoardPageProps) {
