          ...
          <div className="mt-[15px] w-full flex-col gap-y-[20px]">
            {comments.map((comment: SingleCommentResponse) => (
              ...
              >
                <button
                  onClick={() =>
                    handleVisitorProfileModal(comment.author.userId)
                  }
                >
                  {/* 댓글 유저 사진 */}
                  ...
                  {comment.replies.length > 0 &&
                    comment.replies.map((reply: ReplyResponse) => (
                      ...
                      >
                        ...
                        <button
                          onClick={() =>
                            handleVisitorProfileModal(reply.author.userId)
                          }
                        >
                          <div className="w-[34px] h-[34px]">
                            <Image
                        ...
                        <div className="flex-col flex w-full">
                          ...
                          <div className="flex gap-x-[5px]">
                            <div className="mt-[5px] text-xs text-[#a3a3a3] block">
                              {reply.createdAt === reply.modifiedAt ? (
                                <div className="mt-[5px] text-xs text-[#a3a3a3] block">
                                  {changeTimeFormatComment(reply.createdAt)}
                                </div>
                              ) : (
                                <div className="mt-[6px] text-xs text-[#a3a3a3] block">
